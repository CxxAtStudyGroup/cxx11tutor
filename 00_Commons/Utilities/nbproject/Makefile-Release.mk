...
${OBJECTDIR}/Chronometer.o: Chronometer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chronometer.o Chronometer.cpp
...
${TESTDIR}/tests/UtilityTests.o: tests/UtilityTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UtilityTests.o tests/UtilityTests.cpp


${TESTDIR}/tests/utilitytestrunner.o: tests/utilitytestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/utilitytestrunner.o tests/utilitytestrunner.cpp
...
${OBJECTDIR}/Chronometer_nomain.o: ${OBJECTDIR}/Chronometer.o Chronometer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chronometer_nomain.o Chronometer.cpp;\
	else  \
...
${OBJECTDIR}/utility_functions_nomain.o: ${OBJECTDIR}/utility_functions.o utility_functions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility_functions_nomain.o utility_functions.cpp;\
	else  \
